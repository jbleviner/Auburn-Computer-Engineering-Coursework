...
% assign04b.m
% February 15, 2019
% I used the examples from canvas and matlab to help with for.
% Compute health stats for multiple people
...
People = input('Enter number of people for health stats: ');

disp(' ')
%For each person
for p = 1:People
  total = input(['Person # ', num2str(p)]);
